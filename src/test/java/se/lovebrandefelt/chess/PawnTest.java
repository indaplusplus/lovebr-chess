...
class PawnTest {
  ...
  void pawnsCantCaptureForward() {
    ...
    assertTrue(!whitePawn.validMoves().contains(new Position(4, 4)));
  ...
  void pawnsCantMoveDiagonallyForward() {
    Pawn whitePawn = board.add(new Pawn(WHITE), new Position(0, 0));
    Pawn blackPawn = board.add(new Pawn(BLACK), new Position(7, 7));
    assertTrue(!whitePawn.validMoves().contains(new Position(1, 1)));
    assertTrue(!blackPawn.validMoves().contains(new Position(6, 6)));
  }
  ...
  void pawnsCantMoveOutsideTheBoard() {
    ...
    assertTrue(!whitePawn.validMoves().contains(new Position(8, 7)));
    assertTrue(!blackPawn.validMoves().contains(new Position(-1, 0)));
  }
}
